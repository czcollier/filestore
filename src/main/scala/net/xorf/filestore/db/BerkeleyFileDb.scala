package net.xorf.filestore.db

import java.io.File
import java.nio.ByteBuffer
import java.util.UUID

import net.xorf.filestore.db.FileDb.FileRecord
...
class BerkeleyFileDb extends FileDb {
  ...
  import net.xorf.filestore.db.BerkeleyFileDb._

  val config = ConfigFactory.load()

  def baseDir = config.getString("net.xorf.filestore.store.basedir")
  def tmpDir = config.getString("net.xorf.filestore.store.tempdir")
